...
test('crypto_secretbox_open_easy', () => {
  ...
  expect(
    crypto_secretbox_open_easy(
      new Uint8Array([
        ...
        49, 134, 126, 137, 235, 132, 50, 134, 130, 21, 133, 44, 234, 138, 193,
        91, 12,
      ]),
      nonce,
      key
  ...
  expect(
    to_string(
      crypto_secretbox_open_easy(
        new Uint8Array([
          8, 131, 116, 242, 11, 46, 35, 59, 232, 121, 183, 4, 34, 70, 211, 66,
          216, 238, 123, 132, 12, 113, 186, 239, 213, 199, 202, 158, 45, 187,
          165, 136, 244, 105, 39, 18, 206, 125, 95, 114, 178, 16, 26, 74, 69,
          171, 98, 127, 209, 161, 137, 4, 217, 172, 40, 8, 72, 53, 77,
        ]),
        nonce,
        key
      )
