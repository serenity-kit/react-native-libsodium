...
test('crypto_sign_detached', () => {
  ...
  expect(crypto_sign_detached(message, keyPair.privateKey)).toEqual(
    new Uint8Array([
      ...
      200, 168, 70, 229, 251, 204, 208, 244, 105, 184, 217, 146, 173, 186, 63,
      7,
    ])
  );
  expect(crypto_sign_detached(message2, keyPair.privateKey)).toEqual(
    new Uint8Array([
      248, 93, 204, 1, 187, 58, 198, 221, 125, 38, 46, 120, 133, 83, 199, 44, 4,
      8, 236, 242, 234, 108, 134, 20, 196, 239, 185, 4, 109, 149, 207, 153, 132,
      57, 243, 107, 114, 51, 184, 70, 88, 11, 64, 131, 166, 89, 172, 161, 244,
      20, 106, 47, 106, 50, 53, 128, 92, 137, 111, 67, 52, 251, 141, 1,
    ])
  );
  expect(crypto_sign_detached(to_base64(message2), keyPair.privateKey)).toEqual(
    new Uint8Array([
      9, 109, 105, 253, 79, 215, 61, 252, 188, 25, 4, 18, 154, 196, 163, 251,
      148, 103, 42, 103, 188, 142, 254, 92, 15, 110, 168, 3, 207, 237, 30, 93,
      17, 108, 161, 124, 113, 248, 238, 65, 230, 46, 218, 41, 226, 89, 199, 128,
      246, 85, 22, 247, 157, 28, 195, 213, 87, 74, 68, 77, 36, 114, 213, 15,
    ])
  );
