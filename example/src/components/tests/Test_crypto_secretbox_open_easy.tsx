...
export const Test_crypto_secretbox_open_easy: React.FC = () => {
      ...
      <FunctionStatus
        ...
        success={
          ...
          to_string(
            crypto_secretbox_open_easy(
              new Uint8Array([
                107, 200, 44, 53, 220, 73, 233, 105, 148, 23, 198, 167, 238,
                238, 50, 158, 211, 196, 113, 159, 40, 6, 156, 203, 145, 204,
                154,
              ]),
              nonce,
              key
          ...
          isEqualUint8Array(
            crypto_secretbox_open_easy(
              new Uint8Array([
                ...
                110, 82, 147, 70, 237, 218, 45, 172, 33, 170, 197, 198, 184,
                165, 223, 163, 162, 49, 134, 126, 137, 235, 132, 50, 134, 130,
                21, 133, 44, 234, 138, 193, 91, 12,
              ]),
              nonce,
              key
            ),
          ...
          to_string(
            crypto_secretbox_open_easy(
              new Uint8Array([
                ...
                66, 216, 238, 123, 132, 12, 113, 186, 239, 213, 199, 202, 158,
                45, 187, 165, 136, 244, 105, 39, 18, 206, 125, 95, 114, 178, 16,
                26, 74, 69, 171, 98, 127, 209, 161, 137, 4, 217, 172, 40, 8, 72,
                53, 77,
              ]),
              nonce,
              key
