...
export const Test_crypto_box_open_easy: React.FC = () => {
  ...
  try {
    crypto_box_open_easy(
      new Uint8Array([
        7, 9, 231, 28, 150, 42, 179, 98, 167, 141, 62, 183, 24, 32, 73, 231,
        239, 21, 211, 106, 137, 87, 233, 188, 43, 218, 126, 150, 252,
      ]),
      nonce,
      receiverKeyPair.publicKey,
      crypto_box_keypair().privateKey // random private key
    );
  } catch (e) {
      ...
      <FunctionStatus
        ...
        success={
          ...
          to_string(
            crypto_box_open_easy(
              new Uint8Array([
                ...
                231, 239, 21, 211, 106, 137, 87, 233, 188, 43, 218, 126, 150,
                252,
              ]),
              nonce,
              receiverKeyPair.publicKey,
          ...
          isEqualUint8Array(
            crypto_box_open_easy(
              new Uint8Array([
                46, 208, 135, 144, 121, 127, 67, 177, 231, 152, 118, 114, 190,
                79, 51, 6, 175, 151, 79, 47, 140, 241, 35, 197, 98, 206, 84,
                164, 117, 128, 122, 77, 40, 0, 16, 21, 100, 89, 91, 101, 44,
                171, 227, 152, 72, 48, 83, 198,
              ]),
              nonce,
              receiverKeyPair.publicKey,
              senderKeyPair.privateKey
          ...
          to_string(
            crypto_box_open_easy(
              new Uint8Array([
                ...
                191, 56, 228, 63, 217, 113, 173, 44, 184, 128, 114, 207, 38,
                159, 135, 152, 125, 244, 90, 23, 190, 236, 46, 22, 130, 149,
                139, 62, 213, 56, 135, 90, 106, 181, 98, 209, 31, 244, 109, 215,
                244, 217, 102, 38, 151,
              ]),
              nonce,
              receiverKeyPair.publicKey,
