...
import { crypto_sign_detached, to_base64 } from 'react-native-libsodium';
import { isEqualUint8Array } from '../../utils/isEqualUint8Array';
import { FunctionStatus } from '../FunctionStatus';

export const Test_crypto_sign_detached: React.FC = () => {
  ...
  return (
    <FunctionStatus
      ...
      success={
        ...
        isEqualUint8Array(
          crypto_sign_detached(message2, keyPair.privateKey),
          new Uint8Array([
        ...
        isEqualUint8Array(
          crypto_sign_detached(to_base64(message2), keyPair.privateKey),
          new Uint8Array([
